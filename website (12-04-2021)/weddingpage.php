...
<p class="PackagesHeading"> Wedding Services </p>

<div class = "container">

    <p class="package"> 
    	Tiffany Chairs with Cushions for the Guests<br>
    	Chilled Bottle of wine for the toast of the Bride and Groom<br>
    	Red Carpet<br>
    	Pair of White Dove<br>
    	Tables for Registration, Gifts and Wedding Cake<br>
    	Three Layered Fondant Cake<br>
    	Superb Wedding Aisle Décor<br>
    	Menu Labels at the Buffet tables<br>
    	Bridal Car<br>
    	Signature Frame<br>
    	Sound System and Lights<br>
    	Classy Dining Setup with Chinaware, Glassware & Silverware<br>
    	Stylish Couch and Dazzling Backdrop for the Couple<br>
    	Elegant Set-Up for Presidential tables (maximum of 24 persons)<br>
    	Elegant floral centrepiece for the buffet table<br>
    	All tables dressed in floor length tablecloth, set with napkins<br>
    	Bar Setup for Beverage Station<br>
    	Well-Trained Uniformed Waiters<br>
    	Food tasting for two (2) persons only<br>
    </p>
